...
public class ModeloMotoSelectActivity extends AppCompatActivity {
    ...
    public void btnReadModelos(View view) {
        if (Utils.isOnline(getBaseContext())) {
            ...
            new readMarcas().execute("http://fipeapi.appspot.com/api/1/motos/veiculos/" + idMarca + ".json");
        } else {
    ...
    private void configureOnClickModeloItem(final String nameMarca, final long idMarca) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), AnoVeiculoMotoSelectActivity.class);
                ...
                intent.putExtra(MarcaMotoSelectActivity.MARCA_NAME, nameMarca);
                intent.putExtra(MarcaMotoSelectActivity.MARCA_ID, idMarca);
    ...
    private void ToatException(Exception ex) {
        Toast.makeText(ModeloMotoSelectActivity.this, "Formato JSON Inválido"
