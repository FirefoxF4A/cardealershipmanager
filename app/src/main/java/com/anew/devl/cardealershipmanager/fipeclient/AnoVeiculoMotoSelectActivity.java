...
public class AnoVeiculoMotoSelectActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        String modeloName = in.getStringExtra(ModeloMotoSelectActivity.MODELO_NAME);
    ...
    public void btnReadAnoVeiculo(View view) {
        if (Utils.isOnline(getBaseContext())) {
            new readMarcas().execute("http://fipeapi.appspot.com/api/1/motos/veiculo/" + this.marcaId + "/" + this.modeloId + ".json");
        } else {
