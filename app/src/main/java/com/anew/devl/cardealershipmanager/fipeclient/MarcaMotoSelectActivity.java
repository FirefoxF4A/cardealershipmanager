...
public class MarcaMotoSelectActivity extends AppCompatActivity {
    final static String MARCA_ID = "cardealershipmanager.marcaid";
    final static String MARCA_NAME = "cardealershipmanager.marcaname";
    final static String URL_FIPE_JSON_MARCAS = "http://fipeapi.appspot.com/api/1/motos/marcas.json";
    ...
    private void configureOnClickMarcaItem() {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getBaseContext(), ModeloMotoSelectActivity.class);
